# Online-book-store
This project is a complete SQL-based data analysis project built on an Online Book Store dataset. It demonstrates how SQL can be used to design databases, manage data, and extract meaningful insights.

🚀 Project Overview

In this project, I created a relational database with three main tables:
